  ...
  return (
    <>
      ...
      <section className='mb-32'>
        ...
        <div className='mt-10 text-stone-500 dark:text-stone-400 text-sm leading-relaxed max-w-md'>
          <p>
            ...
            <br />I ship production systems and write about the thinking behind
            them.
          </p>
        </div>
      </section>
      ...
      <section>
        ...
        <p className='text-stone-600 dark:text-stone-400 text-sm leading-relaxed max-w-lg'>
          Enterprise-scale React & Next.js applications across multi-team
          environments. Design systems and shared component libraries that
          scale. QA automation and CI/CD pipelines that protect quality.
